...
<div class="header">
    ...
    <a href="mailto:support@fastfi.in">support@fastfi.in</a>
</li>
...
<li>
    ...
    +91 9106407995
                    ...
                    <?php if (empty($_SESSION['ispmsuid'])) { ?>
        ...
        <div class="logo-nav">
            <div class="logo-nav-left">
                <!-- Logo: place your logo file images/fast-fi.png in the images folder -->
                <h1>
    <a href="index.php">
        <img src="images/fast-fi.png" alt="Fast-FI Logo" style="max-height:70px; display:block; margin:5px 0;">
    </a>
</h1>
            ...
            <div class="modal-header">
                ...
                <div class="login-form">
                    <form method="post" name="signup" onsubmit="return checkpass();">
                        ...
                        <!-- fixed name attribute: use confirmpassword (no spaces) -->
                        ...
                        <div class="signin-rit">
                            <span class="agree-checkbox">
                                <label class="checkbox">
                                    ...
                                    I agree to your <a class="w3layouts-t" href="terms.html">Terms of Use</a> and <a class="w3layouts-t" href="privacy.html" target="_blank">Privacy Policy</a>
                                </label>
                            </span>
                        </div>
                        <div class="tp">
...
<script type="text/javascript">
    // simple password match check used by onsubmit checkpass()
    function checkpass(){
